local DTDamageNumber, super = Class(Object, "DTDamageNumber")

function DTDamageNumber:init(type, arg, x, y, color)
    super.init(self, x, y)
...
function DTDamageNumber:update()
    ...
    if (self.timer >= self.delay) and (not self.started) then
        self.started = true
